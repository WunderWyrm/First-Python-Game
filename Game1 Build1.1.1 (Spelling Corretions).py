    ...
    while running == "0":
        ...
        if action1 == "yes":
            ...
            if (key == "yes") and (sword == "yes"):
                print("\nThe troll notices your sword, goes wide-eyed, jumps up and picks up its club.")
                ...
                while running == "0":
                    ...
                    while running == "0":
                        ...
                        if action2 == "yes":
                            ...
                            print("Anger flahses over the troll's face and they pull out its club. \"If you won't give me the key I'll just have to take it from you,\" the troll states angrily.")
                            ...
                            print("\"Now to figure out what to do with you,\" the troll says as its gaze shifts back to you, its mouth in a sneer. A frown creeps onto its face as its gaze looses focus on you. The troll shrugs its shoulders and returns its gaze back to you after its contemplation. \"I can't think of anything fun to do with you, so I just kill you now,\" the troll decides as a malicious grin appears back on its face, and before you can even protest, it slams you into the ground, snapping your neck and killing you instantly.")
                            print("\n---------- GAME OVER ----------")
                            while running == "0":
                                replay = input("\nPlay again?\n(yes, no): ")
                                if replay == "yes":
                ...
                while running == "0":
                    ...
                    if action2 == "yes":
                        ...
                        print("\nYou decide to stay and fight the troll.")
                        print("You draw your sword and start runnig towards the troll. Taken aback by your bravery, the troll stumbles, delaying its swing, allowing you to get close.")
                        ...
                        print("You relize that if you want to defeat the troll, you'll need to cut off its head so that you can kill it before it regenerates. That's going to be a problem, however, since the troll is a good yard taller than you, although you think you can reach if you try.")
                        print("You steel yourself and start running in again. This time the troll is ready for you, and its club swings in at you. You just barely manage to dodge it however and you jump up to the troll's head to cut it off with your sword.")
                        print("The troll's eyes widen with fear as it realizes that its attack missed, and cries, \"Nooo! It can't end like this!\" To the troll's detriment, however, it already has.")
                        print("Your sword ealisly slices through the troll's neck and its body falls to the ground limp. Its head rolls onto the ground, still stuck in the troll's expression of fear. A messy bussiness, but necessary.")
                        ...
                        if kitchenInput == "kitchen":
                            print("You remember the key you saw in the kitchen and decide to go and retrive it.")
                            print("After retriving the key, you make it back to the hall and turn the key in the lock of the door.")
                            print("The keylock turns easily. Soon you hear a click and the key won't turn anymore; the door is open.")
                            print("You walk through the door and you're finally free.")
                            print("\n---------- VICTORY ----------")
                            while running == "0":
                                replay = input("\nPlay again?\n(yes, no): ")
                                if replay == "yes":
